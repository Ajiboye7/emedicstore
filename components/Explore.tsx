  ...
  return (
    <section className="">
      <div className="container mx-auto sm:mt-20 p-8">
        ...
        <TextTitle textStyle=" sm:w-3/5 my-4 sm:my-8">Explore Our Blog <br/> & Articles</TextTitle>
        ...
        {Blog.map((blog) => (
          <div key={blog.id}className="card border border-primaryButtonBg rounded-3xl flex flex-col overflow-hidden">
            ...
            <p className="text-bodyText  blog-text-top mt-5">8 Mins Read</p>
            <p className="blog-text-body text-bodyText font-bold">{blog.body}</p>
            <div className="flex  flex-wrap justify-between my-5">
              <div className="flex whitespace-nowrap gap-2 items-center blog-text-bottom">
