...
const SearchInput = () => {
  return (
    <div className="w-[377px] sm:w-[400px] relative mt-4 md:mt-0 searchInput">
      <input
        type="text"
        placeholder="Enter Product, Active Ingredient or Manufacturer's name"
        className="w-full h-[40px] pl-4 pr-16 py-2 text-sm border border-searchInput rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 search-input-text"
      />
