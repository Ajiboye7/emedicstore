...
const SearchInput = () => {
  return (
    <div className="w-full md:w-[480px] relative mt-4 md:mt-0">
      <input
        type="text"
        placeholder="Enter Product, Active Ingredient or Manufacturer's name"
        className="w-full h-[40px] pl-10 pr-16 py-2 text-sm border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500"
      />
