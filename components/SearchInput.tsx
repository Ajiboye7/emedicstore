...
const SearchInput = () => {
  return (
    <div className="relative w-full md:w-[580px] mt-4 md:mt-0">
      <input
        type="text"
        placeholder="Enter Product, Active Ingredient or Manufacturer's name"
        className="w-full h-[50px] pl-10 pr-16 py-2 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500"
      />
      <div className="absolute right-2 top-1/2 transform -translate-y-1/2 flex items-center bg-black rounded-r-full h-full p-3">
        <Image
          src="/Search Icon.svg"
          alt="Search"
          width={20}
